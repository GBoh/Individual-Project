namespace Individual_project.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Individual_project.Models.DataContext>
    {
        ...
        protected override void Seed(Individual_project.Models.DataContext context)
        {
